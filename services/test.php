...
*/
$apiKey = 'AIzaSyBZNSyCls4CLl8SzFK7j_bxNUeUDp5uiLY';
if (isset($_GET['shortUrl'])){
	$shortUrl = $_GET['shortUrl'];
} else if (isset($_GET['longUrl'])){
...
# Short URL Analytics
$analyticsUrl="https://www.googleapis.com/urlshortener/v1/url?shortUrl=".$shortUrl."&projection=FULL&key=".$apiKey;
